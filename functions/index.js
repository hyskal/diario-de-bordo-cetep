...
exports.smlUpload = onRequest(
  { secrets: ["SML_API_KEY"], cors: ["https://diario-de-bordo-cetep.web.app", "https://diario-de-bordo-cetep.firebaseapp.com", "http://localhost"] },
  async (req, res) => {
    if (req.method !== "POST") {
    ...
    try {
      const { filename, turma, aluno } = req.body;
      ...
      // Passo 2 — fazer PUT com o arquivo (recebido como base64)
